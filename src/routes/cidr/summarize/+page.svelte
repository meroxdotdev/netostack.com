...
<div class="page-container">
  ...
  <section class="explainer-section">
    ...
    <p>
      <strong>CIDR Summarization</strong> optimizes network routing by combining multiple IP addresses, 
      ranges, and CIDR blocks into the minimal set of CIDR prefixes that covers the same address space.
    </p>
    ...
    <div class="modes-section">
      ...
      <div class="modes-grid">
        <div class="mode-item">
          <h5>Exact Merge</h5>
          <p><strong>Conservative approach:</strong> Merges overlapping ranges exactly without additional aggregation</p>
    ...
    <div class="info-box">
      ...
      <p>
        For maximum efficiency, align your network allocations to power-of-2 boundaries. 
        Contiguous address blocks summarize much more effectively than scattered allocations. 
        Use the exact merge mode for conservative summarization or minimal cover for aggressive optimization.
      </p>
    </div>
  </section>
</div>
