...
<svelte:head>
  <title>{ipv6PrefixLengthsContent.title} | {site.title}</title>
  <meta name="description" content="{ipv6PrefixLengthsContent.description}" />
  <meta name="keywords" content="{site.keywords}, IPv6 prefix lengths, IPv6 subnetting, network planning, /64, /48, /32" />
  <meta property="og:title" content="{ipv6PrefixLengthsContent.title}" />
  <meta property="og:description" content="{ipv6PrefixLengthsContent.description}" />
  <meta property="og:url" content="{site.url}/reference/ipv6-prefix-lengths" />
</svelte:head>
