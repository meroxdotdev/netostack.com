...
<svelte:head>
  <title>{supernetContent.title} | {site.title}</title>
  <meta name="description" content="{supernetContent.description}" />
  <meta name="keywords" content="{site.keywords}, supernetting, route aggregation, route summarization, CIDR, routing" />
  <meta property="og:title" content="{supernetContent.title}" />
  <meta property="og:description" content="{supernetContent.description}" />
  <meta property="og:url" content="{site.url}/reference/supernetting" />
</svelte:head>
