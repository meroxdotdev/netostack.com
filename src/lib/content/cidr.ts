  ...
  coreConcepts: [
    {
      icon: 'network',
      title: 'CIDR Notation',
      description: 'The slash notation (like /24) tells you how many bits identify the network portion of an IP address.',
  ...
  howItWorks: [
    {
      ...
      content: 'A /24 network means the first 24 bits identify the network, leaving 8 bits for hosts. That gives you 2^8 = 256 total addresses, minus 2 for network and broadcast = 254 usable hosts.',
      example: {
        type: 'bit',
    ...
    },
    {
      ...
      content: 'Instead of advertising 4 separate /24 networks, you can summarize them into one /22. This reduces routing table size and improves network performance.',
      example: {
        type: 'summary',
        before: {
    ...
    },
    {
      ...
      content: 'Always plan for growth and align to binary boundaries. A /25 gives you room to split into two /26s later, but a /27 doesn\'t divide evenly into /25s.',
      example: {
        type: 'tip',
        title: 'Pro tip:',
