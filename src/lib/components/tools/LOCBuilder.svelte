<script lang="ts">
	...
	const cityExamples = [
		...
		{ name: 'New York', lat: 40.7128, lng: -74.0060, alt: 10 },
	...
	<div class="card">
		...
		<div class="content">
			...
			<div class="mode-toggle">
				<button 
					class="mode-btn"
					class:active={!parseMode}
					onclick={() => parseMode = false}
				>
			...
			<div class="info-section">
				<div class="card info-card">
					...
					<p>
						LOC (Location) records store geographic location information in DNS. They specify latitude, longitude, altitude, and precision values, allowing applications to discover the physical location associated with a domain name.
					</p>
				</div>
...
<style>
	...
	.format-list li, .use-case-list li {
		position: relative;
	...
	.format-list li::before, .use-case-list li::before {
		content: '';
		position: absolute;
		left: 0;
		top: 0.5em;
