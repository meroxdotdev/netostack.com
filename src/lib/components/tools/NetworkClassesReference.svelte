...
<div class="card">
	...
	<section class="tips-section">
		...
		<div class="tips-content">
			<p>
				<strong>Historical Context:</strong> Network classes were the original method of IP address allocation, 
				now largely replaced by CIDR (Classless Inter-Domain Routing) for more efficient address utilization.
			</p>
			<ul class="tips-list">
	...
	<div class="explainer-card">
		...
		<div class="explainer-content">
			<p>
				Network classes provide a standardized way to understand IP address ranges and their intended use. 
				While modern networks use CIDR notation, understanding classes helps with legacy systems and network analysis.
			</p>
