...
<style lang="scss">
	...
	.legend-color {
		...
		&.network { background-color: var(--color-info); }
		&.usable { background-color: var(--color-success); }
		&.broadcast { background-color: var(--color-error); }
		&.host { background-color: var(--text-secondary); }
	}
