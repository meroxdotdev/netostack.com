		...
		<div class="card-content">
			...
			<div class="form-grid">
				...
				<div class="input-section">
					...
					<div class="field-group">
						<label for="mailbox" use:tooltip={"Domain name encoding the email address. Use '.' for no contact specified."}>
							Mailbox Domain Name *
						</label>
						<input
							id="mailbox"
					...
					<div class="field-group">
						<label for="txt" use:tooltip={"Domain name where TXT record with additional contact information can be found. Use '.' for no additional info."}>
							TXT Domain Name
						</label>
						<input
							id="txt"
