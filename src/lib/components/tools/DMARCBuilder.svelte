    ...
    <div class="input-section">
      <div class="domain-section">
        ...
        <div class="input-group">
          <label for="domain" use:tooltip={"Domain that this DMARC policy will protect"}>
            Domain:
          </label>
          <input
            id="domain"
      ...
      <div class="policy-section">
        ...
        <div class="policy-grid">
          ...
          <div class="input-group">
            <label for="percentage" use:tooltip={"Percentage of failing emails to apply policy to (useful for gradual deployment)"}>
              Percentage (pct):
            </label>
          ...
          <div class="advanced-grid">
            ...
            <div class="reporting-section">
              ...
              <div class="reporting-grid">
                ...
                <div class="input-group">
                  <label for="forensicURI" use:tooltip={"Email address to receive forensic failure reports (detailed samples)"}>
                    Forensic Email (ruf):
                  </label>
                  <input
                    id="forensicURI"
            ...
            <div class="failure-options-section">
              <h4 use:tooltip={"When to generate forensic failure reports"}>
        ...
        <div class="deployment-steps">
          <ol>
            {#each deploymentSteps as step, index}
              <li class:current={policy.policy === 'none' && index === 0 || 
...
<style lang="scss">
  ...
  .policy-description, .alignment-description {
  ...
  .alignment-section, .reporting-section, .failure-options-section {
    h4 {
