<script lang="ts">
  ...
  const examples = [
    ...
    },
    {
      ...
      domain: 'company.com',
      records: [
        { priority: 0, mailserver: 'company-com.mail.protection.outlook.com.', role: 'primary' as const }
      ]
    },
    {
...
<div class="card">
  <div class="card-header">
    ...
    <p class="card-subtitle">
      Plan MX record priorities with fallback guidance, best practices, and sample configurations for popular email providers.
    </p>
  </div>
...
.examples-section {
  ...
  .examples-toggle, .guidance-toggle {
    border: 1px solid var(--border-primary);
    border-radius: var(--radius-md);
    padding: var(--spacing-md);
    background: var(--bg-secondary);
  ...
  .priority-guide {
    ...
    .guide-item {
      ...
      &.success { background: rgba(var(--color-success-rgb), 0.1); color: var(--color-success); }
      &.info { background: rgba(var(--color-info-rgb), 0.1); color: var(--color-info); }
      &.warning { background: rgba(var(--color-warning-rgb), 0.1); color: var(--color-warning); }
      &.error { background: rgba(var(--color-error-rgb), 0.1); color: var(--color-error); }
    }
  }
...
.priority-badge {
  ...
  &.success { background: rgba(var(--color-success-rgb), 0.2); color: var(--color-success); }
  &.info { background: rgba(var(--color-info-rgb), 0.2); color: var(--color-info); }
  &.warning { background: rgba(var(--color-warning-rgb), 0.2); color: var(--color-warning); }
  &.error { background: rgba(var(--color-error-rgb), 0.2); color: var(--color-error); }
}
