...
<div class="card">
	...
	<div class="explainer-card">
		...
		<div class="explainer-content">
			<p>
				Choosing the right subnet size is crucial for efficient network design. 
				Consider future growth, address conservation, and security requirements when planning subnets.
			</p>
